    ...
    return(
        ...
        <Grid>
            ...
            <Grid container md={12} justifyContent='space-around'>
                ...
                <Grid item>
                <GreenButton  text='Pay All' bg='#1771a3' radius='10px' 
                        ...
                        <TableBody>
                            <TableRow >
                                ...
                                <TableCell style={{width:'20%'}} >
                                    <GreenButton marginX={2} text='Pay' bg='#1771a3' radius='10px' 
                            ...
                            <TableRow >
                                ...
                                <TableCell className='light-text'>
                                    <GreenButton marginX={2} text='Reciept' bg='#1771a3' radius='10px' 
