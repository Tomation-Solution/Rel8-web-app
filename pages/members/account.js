    ...
    return(
        ...
        <Grid>
            ...
            <Grid container md={12} justifyContent='space-around'>
                ...
                <Grid item>
                <GreenButton  text='Pay All' bg='#365c2a' radius='10px' 
                        ...
                        <TableBody>
                            <TableRow >
                                ...
                                <TableCell style={{width:'20%'}} >
                                    <GreenButton marginX={2} text='Pay' bg='#365c2a' radius='10px' 
                            ...
                            <TableRow >
                                ...
                                <TableCell className='light-text'>
                                    <GreenButton marginX={2} text='Reciept' bg='#365c2a' radius='10px' 
