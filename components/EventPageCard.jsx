    ...
    return(
        <Grid  item md={11} marginY={2}>
                ...
                <Grid container justifyContent='center' alignContent='center'   >
                    <Grid sx={{width: 400, margin:'0 auto' }} paddingX={3} paddingY={4}  position='absolute' top='40%' className='light-green-bg rounded-corners'>
                        ...
                        <Grid justifyContent='center' container>
                            <GreenButton text='Yes' textColor='white' bg='#075a94' paddingX={4} paddingY={1} radius={5} />
                            <GreenButton text='Cancel' textColor='#075a94'  paddingX={4} paddingY={1} radius={5} click={handleClose} />
                        </Grid>
                    </Grid>
            ...
            <Grid md={10} sm={9} style={{margin:'0 auto'}}>
               ...
               textColor='white' paddingY={1} paddingX={1}  bg='#075a94'/>
            </Grid>
        </Grid>
    )
